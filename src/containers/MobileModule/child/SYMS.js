...
class Child extends Component {
                ...
                <div className="yc-Mobile">
                    <div className={this.state.addMP ? 'addMProduct':'addMProduct1'}>
                        ...
                        <div className="addMProduct-bottom">
                            ...
                            <button
                                onClick={this.addMobileProduct1.bind(this)}>
                                新增10点秒杀
                            </button>
                            <button
                                onClick={this.addMobileProduct2.bind(this)}>
                                新增15点秒杀
                            </button>
                            <button
                                onClick={this.addMobileProduct3.bind(this)}>
                                新增20点秒杀
                            </button>
                        </div>
                    </div>
                                        ...
                                        return <div key={index} className='MobileChild-top'>
                                            ...
                                            <div className="MobileChild-top-right">
                                                ...
                                                <p className="MobileChild-top-right-delete"
                                                   onClick={this.DeMobileProduct.bind(this,index)}>
                                                    删除
                                                </p>
                                                <p className="MobileChild-top-right-update"
                                                   onClick={this.showUpMp.bind(this,index,item.img,item.title,item.price,item.id,item.sindex)}>
                                                    修改
                                                </p>
                                            </div>
                                        </div>
    ...
    _getMobileInfo() {
        axios.post("/admGetSYMS")
            .then((res) => {

                let data1 = res.data[0].list1;
                let data2 = res.data[1].list2;
                let data3 = res.data[2].list3;
    ...
    showUpMp(index,img,title,price,id,sindex) {
        this.setState({
            upMP: true,
            Dindex:index,
            URL:img,
    ...
    UpMobileProduct() {
        if (this.state.indexState === true && this.state.priceState === true && this.state.nameState === true && this.state.IDState === true && this.state.URLState === true) {
            axios.post('/admUpdateSYMS', {
                dindex:this.state.Dindex,
                img: this.state.URL,
                title: this.state.name,
                price: this.state.price,
                id: this.state.ID,
